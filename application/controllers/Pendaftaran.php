...
class Pendaftaran extends CI_Controller
{
    ...
    function cetak_riwayat_labor(){
        ...
        $pdf->Cell(190, 6, 'Jl Pesantren Km 2, Cibabat, Cimahi Utara', 0, 1, 'C');
        $pdf->Cell(190, 6, 'No Telpon : +62896232323  Email : rspurwokerto@gmail.com', 0, 1, 'C');
        ...
        // data pasien
         ...
         $pdf->Cell(50, 6, ': '.$pasien['no_rekamedis'], 0, 0, 'l');
         
         $pdf->Cell(50, 6, 'Penanggung Jawab', 0, 0, 'l');
         $pdf->Cell(30, 6, ': '.$pasien['nama_dokter'], 0, 1, 'l');
        
         
         $pdf->Cell(30, 6, 'Nama Pasien', 0, 0, 'l');
         $pdf->Cell(50, 6, ': '.$pasien['nama_pasien'], 0, 0, 'l');
         
         $pdf->Cell(50, 6, 'Dokter Pengirim', 0, 0, 'l');
         $pdf->Cell(30, 6, ': -', 0, 1, 'l');
         
         $pdf->Cell(10,10,'',0,1);
         
         // tabel hasil pemeriksaan
         $pdf->Cell(50, 5, 'Pemeriksaan', 1, 0, 'C');
         $pdf->Cell(20, 5, 'Hasil', 1, 0, 'C');
         $pdf->Cell(20, 5, 'Satuan', 1, 0, 'C');
         $pdf->Cell(50, 5, 'Nilai Rujukan', 1, 0, 'C');
         $pdf->Cell(50, 5, 'Keterangan', 1, 1, 'C');
         
         $pemeriksaan = $this->db->query($sql_labor)->result();
         foreach ($pemeriksaan as $p){
            $pdf->Cell(50, 6, $p->nama_periksa, 1, 0, 'L');
            $pdf->Cell(20, 6, '', 1, 0, 'C');
            $pdf->Cell(20, 6, '', 1, 0, 'C');
            $pdf->Cell(50, 6, '', 1, 0, 'C');
            $pdf->Cell(50, 6, '', 1, 1, 'C');
         ...
         $pdf->Cell(10,1,'',0,1);
         $pdf->Cell(120,1,'',0,0);
         $pdf->Cell(50,5,'Tanggal Cetak : '.date('Y-m-d H:i:s'),0,1,'C');
         $pdf->Cell(120,5,'',0,0);
         $pdf->Cell(50,5,'Petugas Laboratorium',0,1,'C');
         
         $pdf->Cell(1,7,'',0,1);
         
         $pdf->Cell(120,5,'',0,0);
         $pdf->Cell(50,5,'Nuris Akbar',0,1,'C');
