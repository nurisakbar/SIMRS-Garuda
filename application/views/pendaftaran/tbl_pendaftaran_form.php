...
<!--<input type="text" class="form-control" name="cara_masuk" id="cara_masuk" placeholder="Cara Masuk" value="<?php echo $cara_masuk; ?>" /></td></tr>-->
                            <tr><td>Ruangan Dirawat</td><td>
                                    <div class="row">
                                        <div class="col-md-7">
                                            <input type="text" id="tempat_tidur" name="kode_tempat_tidur" placeholder="Masukan Kode Tempat Tidur" class="form-control">
                                        </div>
                                        <div class="col-md-3">
                                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal">Pilih Kamar</button>
                                        </div>
                                    </div>
                                </td></tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Cari Kamar</h4>
            </div>
            <div class="modal-body">

                <table class="table table-bordered">
                    <tr><th colspan="2">Filter Data</th></tr>
                    <tr><td>Kelas</td><td><?php echo form_dropdown('kelas', array('VIP' => 'VIP'), null, "class='form-control'"); ?></td></tr>
                    <tr><td>Nama Ruangan</td><td><input type="text" id="kamar" placeholder="Masukan Nama Ruangan" class="form-control"></td></tr>
                </table>
                <div id="table_kamar"></div>
            </div>
...
<script type="text/javascript">
    ...
    function tampil_kamar(){
        $.ajax({
            url:"<?php echo base_url(); ?>index.php/pendaftaran/tampil_kamar_ajax",
            data:"" ,
            success: function(html)
            {
                $("#table_kamar").html(html);
            }
        });
    }
